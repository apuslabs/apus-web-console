          ...
          items={[
              {
                  ...
                  description: <div>
                      <Button type="default" onClick={switchSepolia} className="mb-2">Connect to Sepolia</Button>
                      <br />
                      <Button type="default" onClick={switchTaiko}>Connect to Taiko</Button>
                  </div>,
              },
              {
                  title: 'Add tokens to your wallet',
                  description: <div>
                      <Button type="default" onClick={addAPEToken}>Add APE Token</Button>
                  </div>,
              },
          ]}
        />
